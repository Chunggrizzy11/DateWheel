    ...
    <div ref={containerRef} className="page-container">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-3">
          <Button variant="outline" onClick={() => handleOpenFolderModal()} className="gap-2"><FolderPlus size={18} /> New Folder</Button>
          <Button onClick={() => handleOpenCatModal()} className="gap-2"><Plus size={18} /> New Category</Button>
        </div>
      </div>
